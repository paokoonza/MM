...
||======= FOR ADMIN =======||
  ...
  =======================
    ****ᴛʜᴇᴀᴍ ᴄʀᴇᴀᴛᴏʀ ʙᴏᴛ****
 ***ᴄʀᴇᴀᴛᴏʀ ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™***
    http://line.me/ti/p/~0956506066
               **ʙᴏᴛ ᴘʀᴏᴛᴇᴄᴛ**

              •   S҉̶̶̘̟̼̉̈́͐͋͌̊҉̶̘̟̼̉̈́͐͋͌̊K҉̶̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊Y҉ͩ͂҉̘̟̼̉̈́͐͋͌̊҉̶̶̘̟̼̉̈́͐͋͌̊⚒̶̶B҉̶̶̘̟̼̉̈́͐͋͌̊Ω҉̶̘̟̼̉̈́͐͋͌̊T҉̶̘̟̼̉̈́͐͋͌̊S҉̶̘̟̼̉̈́͐͋͌̊   •
  =======================
...
Bots = [mid,"u999427ee98d55e99e9634eb7fb3358f9"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"***ᴄʀᴇᴀᴛᴏʀ ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™***",
    "lang":"JP",
    "comment":"***ᴄʀᴇᴀᴛᴏʀ ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™***",
    "commentOn":False,
    "likeOn":False,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    ...
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u999427ee98d55e99e9634eb7fb3358f9":
                    if "join:" in msg.text:
...
# ----------------- NOTIFED MEMBER OUT GROUP
         if op.type == 15:
           if op.param2 in bot1:
                return
            cl.sendText(op.param1,"🇹🇭งานเลี้ยงย่อมมีการเลิกลาครับ🇹🇭\n\n🇹🇭แล้วเอาไว้เราค่อยเจอกัน🇹🇭\n🇹🇭เมื่อเวลานั้นมาถึง🇹🇭\n\n🇹🇭เจอกันเมื่อชาติต้องการ🇹🇭")
            print "MEMBER HAS LEFT THE GROUP"
#------------------ KICK OUT FORM GROUP
        if op.type == 19:
            if op.param2 in Bots:
                return
            cl.sendText(op.param1,cl.getContact(op.param2).displayName + " โอ้โห้มึงเอ่ยยจังหวะนี้\nชัดเต็มข้อล้อเต็มแข้ง\nจุกไปไม่น้อยครับ🇹🇭")
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            ...
            cl.sendText(op.param1, "🇹🇭Hello2018 สวัสดีปีใหม่🇹🇭\n🇹สวัสดีค้าบยินดีต้อนรับนะครับคุณ" + cl.getContact(op.param2).displayName + "เข้าสู่กลุ่ม " + "👉" + str(ginfo.name) + "👈""\n\nรบกวนปิดการแจ้งเตือนด้วยนะครับ\nกลุ่มนี้ยินดีต้อนรับเสมอครับ\n\nสุดท้ายเดินทางปลอดภัยนะครับ🇹🇭")
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "==============================\nActive readers:%s\n\n\n\nPassive readers:\n%s\n\n==============================\nIn the last seen point:\n[%s]\n==============================\n Powered ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "ReadPoint Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
...
#----------------------ADMIN COMMAND------------------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™")

            elif cms(msg.text,["ผู้สร้าง","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                cl.sendText(msg.to,"􀜁􀇔􏿿 ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™􀇔􏿿 ")
                cl.sendMessage(msg)
