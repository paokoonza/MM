...
cl = ASUL.LINE()
#cl.login(qr=True)
cl.login(token="Eo2dPREeIM4mJOimcS99.nnBoNbIlLHC3yh3xiCI2kq.FsWbk25GFpm1Bj8aYPLqrGcYHd6Q7QBAwjHyf4DYagk=")
cl.loginResult()
...
print u"ล็อคอิน เรียบร้อยแล้วBy.มิน"
reload(sys)
...
# ----------------- NOTIFED MEMBER OUT GROUP
        if op.type == 15:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,"งานเลี้ยงย่อมมีการเลิกลา\nไว้เราค่อยเจอกันครับ" + cl.getContact(op.param2).displayName + "  \n\n🇹🇭ขอให้โชคคดีครับ\n\n🇹🇭ไว้เจอกันเมื่อชาติต้องการ🇹🇭\n👉ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™👈") 
            print ("MEMBER HAS LEFT THE GROUP")
#------------------ KICK OUT FORM GROUP
        if op.type == 19:
            if op.param2 in bot1:
                return
            cl.sendText(op.param1,cl.getContact(op.param2).displayName + " โอ้โห้จังหวะนี้ชัดเต็มข้อลอเต็มแข้ง\nทำเอากระผมอึ่งเลยทีเดียว\n\n👉ʙʏ  ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™👈")
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            ...
            cl.sendText(op.param1, "👏สวัสดีปีใหม่ครับ🌌\nยินดีต้อนรับนะครับคุณ" + cl.getContact(op.param2).displayName + "เข้าสู่กลุ่มของเรา " + "👉" + str(ginfo.name) + "👈""\nอย่าลืมปิดการแจ้งเตือนด้วยนะครับ\n\n🇹🇭ยินดีต้อนรับเสมอครับ🇹🇭\nʙʏ➣zᴱn ᴃᴏᴛ ᴌᵻᴎᴇ™👈")
