...
cl = ASUL.LINE()
#cl.login(qr=True)
cl.login(token="EodnawdPFqVM3LnNqKoa.OCTUHf+O8MrV6kxfKrHb/G.omKNjdqBehTvnWQiUNTECo8OeoJl1t+lrrs2DlCGpck=")
cl.loginResult()
ki=ki2=ki3=ki4=cl
...
🙆Gname         - คนสร้างกลุ่ม
-----------------------
🙆Banlist       - เช็คแบนท้้งหมด
-----------------------
🙆Details grup  - เรามิรู้
-----------------------
🙆Inviteme:     - อันนี้ก็มิรู้
-----------------------
🙆Info grup     มิรู้เลยครับ
-----------------------
🙆Clear grup   มิรู้อีกแล้ว
-----------------------
🙆 Reject    - ลบรัน💥
-----------------------
🙆Aslogin  
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        if op.type == 17:
            ...
            cl.sendText(op.param1, "ยินดีต้อนรับเข้าสู้กลุ่มขอเรานะ " + cl.getContact(op.param2).displayName + "กลุ่มนี้ยินดีต้อนรับครับ " + "👉" + str(ginfo.name) + "👈""\n\nมาแล้วก็อย่าสร้างความวุ่นวายนะ \nและสุดท้ายย\n\n สวัสดีปีใหม่นะครับ 2018 \nขอให้ทุกคนมีความสุขนะครับ\n😝😋😗😙🙋🙌😘😘😘")
